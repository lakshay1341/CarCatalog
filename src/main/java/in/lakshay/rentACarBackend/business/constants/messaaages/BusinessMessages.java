package in.lakshay.rentACarBackend.business.constants.messaaages;  // typo in package name lol

// holds all the message constants for the app
// keeps messages consistent and in one place
// note: there's a typo in the package name but fixing it would break imports
public class BusinessMessages {
    // this file is getting huge... maybe split by domain?

    // generic messages used across the app
    public class GlobalMessages{
        // success messages
        public static final String DATA_LISTED_SUCCESSFULLY = "Data Listed Successfully";  // for lists
        public static final String DATA_ADDED_SUCCESSFULLY = "Data Added Successfully";  // for creates
        public static final String DATA_UPDATED_SUCCESSFULLY = "Data updated Successfully, dataId: ";  // for updates
        public static final String DATA_DELETED_SUCCESSFULLY = "Data deleted successfully, dataId: ";  // for deletes
        public static final String DATA_BROUGHT_SUCCESSFULLY = "Data Brought Successfully, dataId: ";  // for gets

        // todo: add more generic messages here?
    }


    // messages for additional services (extras like GPS, baby seats, etc)
    public class AdditionalMessages{
        // error messages
        public static final String ADDITIONAL_ID_NOT_FOUND = "Additional Service ID not exists, additionalId: ";  // 404 basically
        public static final String ADDITIONAL_NAME_ALREADY_EXISTS = "Additional Service name already exists, name: ";  // duplicate

        // todo: add success messages specific to additionals?
    }

    // messages for car brands (Toyota, BMW, etc)
    public class BrandMessages{
        // error msgs
        public static final String BRAND_ID_NOT_FOUND = "Brand ID not exists, brandId: ";  // not found
        public static final String BRAND_NAME_ALREADY_EXISTS = "Brand name already exists, name: ";  // duplicate

        // might need more specific msgs later
    }

    // messages for car crashes/accidents
    public class CarCrashMessages{
        // success msg
        public static final String CAR_CRASH_LISTED_BY_CAR_ID = "Car Crash listed successfully by car ID, carId: ";  // list

        // error msgs
        public static final String CAR_CRASH_ID_NOT_FOUND = "Car Crash ID not exists, carCrashId: ";  // not found
        public static final String CRASH_DATE_CANNOT_AFTER_TODAY = "Crash date cannot be after today, crashDate: ";  // future date
        public static final String CAR_ID_ALREADY_EXISTS_IN_THE_CAR_CRASH_TABLE = "Car ID already exists in the Car Crash table, carId: ";  // duplicate

        // note: should probably rename this to accidents instead of crashes
    }
